...
@section('content')
    <fieldset id="articleList" class="layui-elem-field layui-field-title sys-list-field" style="display:block;">
        <legend id="articleBoxTitle" style="text-align: center">修改商品</legend>
        <div class="layui-field-box">
            <div>
                <form id="editForm" class="layui-form form-main" style="width:70%;margin: 0 auto;">
                    <div class="layui-form-item">
                        <label class="layui-form-label">商品名称</label>
                        <div class="layui-input-block">
                            <input type="text" name="name"  lay-verify="name" value="{{ $good->name }}" placeholder="请输入商品名称" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <select name="type" lay-verify="required">
                                ...
                                <option value="{{ $type->id }}" @if($good->type_id == $type->id) selected @endif>{{ $type->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline" style="width: 120px;">
                            <input type="text" name="number" value="{{ $good->number }}" lay-verify="number" placeholder="1-100000" autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">商品价格</label>
                        <div class="layui-input-inline" style="width: 120px;">
                            <input type="text" name="price" value="{{ $good->price }}" lay-verify="price" placeholder="1-100000飞吻"  autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item" style="position:relative;">
                        ...
                        <div class="layui-input-inline">
                            ...
                            <img id="goodsImg" width="192px" height="128px" class="img-cover" src="{{ $good->img }}" alt="封面">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="checkbox" @if($good->is_use == 1) checked @endif name="is_use" lay-skin="switch" lay-filter="switchTest" title="开关">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
                            <button class="layui-btn" lay-submit="" lay-filter="editGoods">修改</button>
    ...
    <script>
        ...
        layui.use(['form'],function () {
            ...
            form.on('submit(editGoods)', function(data){
                ...
                $.ajax({
                    url:'/admin/goods/{{ $good->id }}/updateGoods',
                    type:'post',
                    data:fd,
                    processData:false,
                    contentType:false,
