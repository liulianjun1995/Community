                ...
                <div class="layui-row layui-col-space15 layui-form-item">
                  <div class="layui-col-md3">
                    ...
                    <div class="layui-input-block">
                      <select lay-verify="required" disabled="disabled" name="category" lay-filter="column" readonly>
                        <option></option>
                  ...
                  <div class="layui-col-md9">
                    ...
                    <div class="layui-input-block">
                      <input type="text" id="L_title" name="title" required lay-verify="title" value="{{ $post->title }}" autocomplete="off" class="layui-input">
                    </div>
                  </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    <div id="my-editormd" >
                        <textarea id="my-editormd-markdown-doc" name="content" style="display:none;">{{ $post->content }}</textarea>
                        <!-- 注意：name属性的值-->
                  ...
                  <div class="layui-inline">
                    ...
                    <div class="layui-input-inline" style="width: 190px;">
                      <select name="reward" disabled="disabled">
                        <option value="{{ $post->reward }}" selected>{{ $post->reward }}</option>
                      </select>
                    </div>
